...
-- 5. Get Publishers who sold the most copies (including returns)
select Name
...
-- 13. Return the percentage of orders that get returned within a month of each genre/category
...
-- 13. Customers who make the most orders in the most recent year
select Customers.*
...
-- 14. Get customers who bought the most copies of book
...
-- 15. Get the favourite genre/category of each customer
...
-- 16. Get info of customers who bought more than 2 copies of any book
select c1.*
...
-- 17. Return the customers with valid credit card numbers according to Luhn’s algorithm:
